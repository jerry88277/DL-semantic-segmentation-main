...
def init_arguments():
    ...
    # General
    parser.add_argument('-s', '--seed', type=int, default=4019)
    ...
    parser.add_argument('-Py', '--PATH_y', type=str, default='semantic_annotations/gtLabels/')
    ...
    parser.add_argument('-wtr', '--num_workers_tr', type=int, default=4)

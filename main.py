...
def main(args):
    ...
    print('arrange raw data into training, validation, testing folder')
    ...
    folder_name = os.path.join(args.savePATH, dt + args.ENCODER + '_bs=' + str(args.batch_size) + '_epochs=' + str(args.epochs))
    ...
    #         torch.save(model, os.path.join(folder_name, 'best_model.pth'))
    #         print('Model saved!')
    #     if i == 25:
...
if __name__ == '__main__':
    ...
    print(args.produce_predicted_images)
